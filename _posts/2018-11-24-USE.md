...
As I had touched upon earlier, it is important to know what kind of data the encoder was trained on. This will give us an idea of what are the suitable tasks to use this model for. 
