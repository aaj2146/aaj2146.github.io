...
Transfer Learning tasks | [Movie review sentiment on a 5 star scale](http://www.cs.cornell.edu/home/llee/papers/pang-lee-stars.pdf), [Sentiment of sentences mined from customer reviews](https://www.cs.uic.edu/~liub/publications/kdd04-revSummary.pdf), [Subjectivity of sentences from movie reviews and plot summaries] (https://www.cs.cornell.edu/home/llee/papers/cutsent.pdf), [Phrase level opinion polarity from news data (https://link.springer.com/article/10.1007%2Fs10579-005-7880-9), [Fine grained question classification sourced from TREC](https://dl.acm.org/citation.cfm?doid=1072228.1072378), [Binary phrase level sentiment classification](https://nlp.stanford.edu/~socherr/EMNLP2013_RNTN.pdf), [Semantic textual similarity (STS) between sentence pairs scored by Pearson correlation with human judgments](http://www.aclweb.org/anthology/S17-2001)[Word pairs from the psychology literature on implicit association tests (IAT) that are used to characterize model bias] (http://science.sciencemag.org/content/356/6334/183)
{: .tablelines}
