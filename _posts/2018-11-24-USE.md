...
We will now look at USE in action. Movie reviews from IMDB will be fed into the encoder which will convert them to fixed length 512 dimensional vectors that will then go into a Fully connected Neural Netwrok. Let's dive right into it!
